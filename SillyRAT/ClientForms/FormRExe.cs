...
{
    public partial class FormRExe : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    label4.Text = path;
                    label5.Text = information.Name;
                    label2.Text = $"Size: {totalsize}";
        ...
        private void FormRExe_Load(object sender, EventArgs e)
        {
            ...
            button3.Region = new Region(CreateRoundPath(button2.ClientRectangle, 15));
            timer1.Start();
        }
