...
namespace Client.Things
{
    internal class Config
    {
        ...
        public static string Host = "silly2";
        public static int Port = Convert.ToInt32("silly3");
        ...
        public static bool Assist = Convert.ToBoolean("silly12");
        ...
        public static bool UACBy = Convert.ToBoolean("silly19");
